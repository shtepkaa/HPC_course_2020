...
int main(int argc, char* argv[])
{
    ...
    if (rank == 0)
    {
        ...
        printf("initialpattern: %s\n", initialpattern);  
        //printf("initialpattern_local rank %d: %s\n ",rank, initialpattern_local);
            ...
            if (rank == 0) // gathering
            {
                ...
                {  
                    ...
                    for (int j = 1; j < cellcount_local+1; j++) 
                    {
                        ...
                        printf("proc %d res = %d\n", proc, result[i][proc*cellcount_local+j-1]);
                    }
                }
            }
